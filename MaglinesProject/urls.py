...
urlpatterns = [    
    ...
    url(r'^LMList/new_Branch$', views.new_bcompany, name='new_bcompany'),
    url(r'^LMList/(\d+)/$', views.view_bcompany, name='view_bcompany'),
    url(r'^LMList/(\d+)/add_info$', views.add_info, name='add_info'),]
